...
const BLOG = {
  ...
  THEME: 'lrac', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'L-Rac', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '写代码、设计与生活的小浣熊。保持好奇，也保持自己的节奏。', // 作者简介
  LINK:
    process.env.NEXT_PUBLIC_LINK ||
    (process.env.VERCEL_PROJECT_PRODUCTION_URL
      ? `https://${process.env.VERCEL_PROJECT_PRODUCTION_URL}`
      : 'http://localhost:3000'), // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'L-Rac,博客,Notion,技术,设计,生活,数字花园', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/lrac/raccoon-reference.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
